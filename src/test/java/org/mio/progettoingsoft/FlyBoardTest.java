...
//        assertFalse(fly.getScoreBoard().stream()
//                .anyMatch(player -> player.getNickname().equals("Test"))
//        );
//
...
//                    player -> player.getNickname().equals(user)
//            ));
//        }
//
//    }
...
//
//        board.addUncoveredComponent(refused.getId());
//
...
//        FlyBoard board = FlyBoard.createFlyBoard(GameMode.NORMAL, )
//        board.addPlayer("Stefano", HousingColor.BLUE);
//        //input utente: pesca coperto
//        Component c = board.drawComponent();
//        assertNotNull(c);
