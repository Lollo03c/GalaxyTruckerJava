...
public class VisualShipboardEasy extends VisualShipboard {

    public VisualShipboardEasy(List<Optional<Component>> components) {
        super(components);
        this.rows = 5;
        this.cols = 5;
    }
    ...
    public static void main(String[] args) throws IOException {
        ...
        components.add(Optional.of(fullDepot));
        components.add(Optional.of(energyDepot));
        VisualShipboardEasy visual = new VisualShipboardEasy(components);
        visual.drawShipboard();
    }
}
