...
public sealed abstract class Message  implements Serializable permits AddPlayerMessage, AdvancePlayerMessage, AvailablePlacesMessage, ChoosePlacementMessage, ComponentMessage, DeckMessage, DoubleEngineMessage, EndBuildMessage, FlyBoardMessage, GameIdMessage, GameInfoMessage, NicknameMessage, StardustMessage, StateMessage, WelcomeMessage {
