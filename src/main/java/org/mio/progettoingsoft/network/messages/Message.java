...
public sealed abstract class Message  implements Serializable permits AddCreditsMessage, AddPlayerMessage, AdvancePlayerMessage, AvailablePlacesMessage, CardStateMessage, ChoosePlacementMessage, ComponentMessage, CrewLostMessage, DeckMessage, DoubleEngineMessage, DrawCardMessage, EndBuildMessage, FlyBoardMessage, GameIdMessage, GameInfoMessage, NicknameMessage, StardustMessage, StateMessage, WelcomeMessage {
