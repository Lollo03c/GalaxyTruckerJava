...
public sealed abstract class Message  implements Serializable permits AddCreditsMessage, AddPlayerMessage, AdvancePlayerMessage, AvailablePlacesMessage, BuildShipMessage, CardStateMessage, ChoosePlacementMessage, ComponentMessage, CrewRemoveMessage, DeckMessage, DoubleEngineMessage, DrawCardMessage, EndBuildMessage, FlyBoardMessage, GameIdMessage, GameInfoMessage, LeaveMessage, NicknameMessage, SkipEffectMessage, StardustMessage, StateMessage, WelcomeMessage {
